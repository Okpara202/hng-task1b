const profile = {
  name: "Favour Okpara",
  bio: "Frontend Engineer building accessible interfaces and scalable UI systems.",
  avatar: "./images/favour.jfif",
  socials: [
...
function renderProfile() {
  ...
  hobbiesEl.innerHTML = profile.hobbies.map((h) => `<li>${h}</li>`).join("");

  dislikesEl.innerHTML = profile.dislikes.map((d) => `<li>${d}</li>`).join("");
}
